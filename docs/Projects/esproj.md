...
<div class="hero">
  ...
  <div>
    <a class="hero-cta primary" href="./Projects/projects/">← Back to Projects</a>
...
<article class="project-card">
  <img class="project-thumb" src="/docs/subfolder/EmbSysProj/RL_PCB.jpg" alt="ESP32 Wi-Fi subsystem PCB">
  <div>
