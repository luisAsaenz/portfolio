...
<article class="project-card">
  <img class="project-thumb" src="Projects/CMDEProj/gerber_pcb.png" alt="Docking Drone thumbnail">
  <div>
    ...
    <p style="margin-top:8px;"><a href="/Projects/cmdeproj/" class="hero-cta ghost" style="padding:8px 12px;font-size:0.95rem;">View Case Study</a></p>
  </div>
</article>
